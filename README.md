...
<head>
    ...
    <style>
        ...
        .background {
            ...
            width: 100%;
            height: 100%;
            background: url('[https://raw.githubusercontent.com/flowlearnerapp/flowlearnerapp.github.io/refs/heads/main/Flowlearnerapp%20background.jpg](https://github.com/flowlearnerapp/flowlearnerapp.github.io/blob/main/Flowlearner%20dark%20.png?raw=true](https://github.com/flowlearnerapp/flowlearnerapp.github.io/blob/main/Flowlearner%20dark%20.png?raw=true)') no-repeat center center / cover;
            z-index: 0;
        }
        body {
            color: black;
